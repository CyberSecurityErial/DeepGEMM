...
sm90_fp8_mega_moe_impl(void* y,
    ...
    // Conservative reusable region for combine. The runtime assertion below
    // checks the full distance to the barrier area, including SFA storage.
    ...
    // GEMM TMA load warps
        ...
        // GEMM math, epilogue, and combine warpgroups
