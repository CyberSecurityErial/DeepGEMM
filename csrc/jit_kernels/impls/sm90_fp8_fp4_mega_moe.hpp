...
static void __instantiate_kernel() {{
    ...
    args.config.num_dispatch_threads, args.config.num_mma_threads, args.config.num_epilogue_threads,
...
static void sm90_fp8_fp4_mega_moe(
    ...
    // TODO(sm90-mega-moe): fill the Hopper path in this order:
    // 1. Select SM90MegaMoEConfig in csrc/jit_kernels/heuristics/sm90_mega_moe.hpp.
    // 2. Build SM90-compatible TMA descriptors for activations, scales, weights, and L1 output.
    // 3. Populate SM90FP8FP4MegaMoERuntime::Args and launch the generated kernel.
    DG_HOST_UNREACHABLE("SM90 MegaMoE scaffold is wired but not implemented yet");
}
